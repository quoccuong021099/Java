...
<div class="container">
 ...
 <div class="menu">
		<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
			<div class="nav-right">
				<a class="navbar-brand" href="sach2.jsp"><i class="fas fa-home"></i> Trang chủ</a>
			</div>
			<div class="nav-left">
...
<div class="col-3">
 <nav class="navbar navbar-light bg-light">
            <form class="form-inline m-auto" action="sach2.jsp" method="post">
              <input
	...
	<div class="list-group">
	     <a href="sach2.jsp?maloai=<%=ds2.get(i).getMaloai()%>" class="list-group-item list-group-item-action list-group-item-light">
...
%>     
	...
	<% sachbean ss=ds.get(i); %>
		...
		<a href="datmua.jsp?ms=<%=ss.getMasach()%>&ts=<%=ss.getTensach()%>&tg=<%=ss.getTacgia()%>&gia=<%=ss.getGia()%>&ml=<%=ss.getMaloai()%>&anh=<%=ss.getAnh()%>"> <img alt="" src="asset/img/buynow.jpg"> </a> 
		</div>
	</div>
<%} %>
    </div>
